...
$config->custom->session['blowfish'] = 'fe6708baabbbb6fab28bf4df973b7b58';  # Autogenerated for ldap
...
$servers->setValue('server','name','CEC LDAP Server');
...
$servers->setValue('server','base',array('dc=cecdat,dc=com'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
#$servers->setValue('login','bind_id','cn=Manager,dc=cecdat,dc=com');
#  $servers->setValue('login','bind_id','cn=Manager,dc=example,dc=com');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
// $servers->setValue('login','bind_pass','');
#$servers->setValue('login','bind_pass','cecdata@123');
